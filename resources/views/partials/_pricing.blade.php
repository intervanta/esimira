    ...
    <div class="w-full max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-12">
            <div class="flex items-center justify-center gap-2 mb-4">
                ...
                <span class="text-[12px] font-medium text-[#000000] uppercase">our Plans</span>
            </div>
            <h2 class="text-[28px] sm:text-[32px] lg:text-[35px] font-normal text-[#101010] capitalize text-center">

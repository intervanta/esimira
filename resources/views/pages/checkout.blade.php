...
@section('content')
    ...
    <main id="checkout" class="checkout-section py-16">
        <div
            class="container main-grid w-full max-w-[1140px] mx-auto px-4 sm:px-6 lg:px-8 flex flex-col lg:flex-row gap-24">
            <div class="cart-details">
                <h2 class="cart-title">My <span class="text-primary-checkout">Cart</span></h2>

                <!-- Plan Summary -->
                <div class="checkout-card-two">
                    <div class="plan-summary-card">
                        <h3 class="card-subtitle">Your Plan</h3>
                        <div class="plan-details-checkout">
                            <img src="{{ asset('assets/images/365_406.svg') }}" alt="Flag">
                            <div class="plan-text">
                                <div class="plan-info">
                                    <p class="plan-name">{{ $bundle->name }}</p>
                                    <p class="text-lg font-bold text-primary-checkout">
                                        <span
                                            class="text-primary-checkout">{{ $refill->amount_mb >= 1024 ? number_format($refill->amount_mb / 1024, 1) . ' GB' : $refill->amount_mb . ' MB' }}</span>
                                        <span class="text-black-checkout">• {{ $refill->amount_days }} Days</span>
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="accept-all">
                        ...
                        <span style="color: #505050;">I confirm my device is <strong>eSIM-compatible</strong> and
                            ...
                            I agree to the <span style="color: #f4633a;font-weight: 600;">Terms</span> & <span
                                style="color: #f4633a;font-weight: 600;">Privacy Policy</span>.</span>
                        ...
                        <label class="payment-option method-card active" data-method="razorpay">
                            <div class="method-content-row">
                                <div class="logo-wrapper">
                                    <img src="../assets/images/c47ad343bd45842086fcdfe5f7eb813922d552c9.png">
                                </div>
                            </div>
            ...
            <aside class="payment-summary">
                ...
                <div class="summary-details-check">
                    ...
                    <div class="summary-item">
                        ...
                        <span class="convenience-fee plan-price" data-price="{{ $priceData['total_convenience_fee'] }}">
                ...
                <div id="miravaultDiscountRow" class="flex justify-between text-green-600 hidden">
                    ...
                    <span>-<span id="miravaultDiscountAmount" class="plan-price">{{ $currencySign }}0.00</span></span>
                </div>
                ...
                <div id="couponDiscountRow" class="hidden">
                    <div class="flex justify-between text-green-600">
                        ...
                        <span>-<span id="couponDiscountAmount" class="plan-price">{{ $currencySign }}0.00</span></span>
                    </div>
                </div>
                ...
                <div class="mv-container">
                    <h3 class="mv-title">MiraVault & Coupons</h3>
    ...
    Cancel
                        ...
                        <!-- <div class="mv-card">
                            <div class="mv-card-left">
                                ...
                                <div class="mv-icon-box">
                                    <img src="../assets/images/422_288.svg" alt="Coupon Icon" class="mv-icon">
                                </div>
                                <div>
                                ...
                                <button type="button" class="use-coupon-btn mv-btn">
                                    Apply Code
                                </button>
                            </div>
                        </div> -->
                    ...
                    <div class="space-y-2 mt-4">
                        <!-- MiraVault Applied -->
                        <div id="miravaultApplied" class="bg-blue-50 border border-blue-200 rounded-lg p-3 hidden">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-sm text-blue-800">MiraVault:
                                        {{ $currencySign }}<span id="appliedMiravaultAmount">0.00</span>
                                        applied</span>
                                </div>
